...
cd ~/.config/hypr/hyprland.conf 
# set monitor to monitor=DP-1,1920x1080@60,0x0,1 or monitor=eDP-1,1920x1080@60,0x0,1 if it's a laptop.
...
# export const Clock = ({ format = '%m/%d (%a) %H:%M', # This line seems to be JavaScript code, not sure where you want to use it.
